    ...
    private IEnumerator MoveToNextCheckpoint(int currentCheckpointIndex)
    {
        ...
        for (int i = currentCheckpointIndex; i < path.pathpoints.Count; i++)
        {
            ...
            if (path.pathpoints[i].isSwapScene)
            {
                ...
                {
                    GameManager.instance.npcManager.UpdateLocation(npcData, path.pathpoints[i].mapName);
                    Destroy(this.gameObject);
                    yield return null;
                }
                else
...
//             else
//             {
//                 Debug.Log("Rain is not done.");
//                 if (path.pathpoints[index].mapName != SceneManager.GetActiveScene().name)
//                 {
//                     Debug.Log("Rain got destroyed");
//                     Destroy(this.gameObject);
//                 }
//                 else
//                 {
//                     Debug.Log("starting coroutine for index: " + index);
//                     StartCoroutine(MoveToNextCheckpoint(index));
//                 }
//             }
//         }
